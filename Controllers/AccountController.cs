...
using ADProjectBase2.Models.AccountViewModels;
using ADProjectBase2.Services;
...
namespace ADProjectBase2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            {
                ViewData["ReturnUrl"] = returnUrl;
                string[] roles = { "employee", "head", "supervisor", "manager", "clerk", "actinghead", "representative" };
                ViewData["Roles"] = new SelectList(roles);
                string[] depts = { "Life Sciences", "Commerce", "Computer Science", "Registrar", "Zoology", "Business", "Administration", "Engineering", "English", "Store" };
                ViewData["Departments"] = new SelectList(depts);
                return View();
            }
